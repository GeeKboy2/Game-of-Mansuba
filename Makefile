...
project: geometry.o world.o neighbors.o hexagone.o triangle.o project.o show_world.o pawn.o tour.o elephant.o rules.o # (Add your dependency here, e.g "project.o")
	$(CC) $(CFLAGS) geometry.o world.o neighbors.o hexagone.o triangle.o project.o show_world.o pawn.o tour.o elephant.o rules.o -o project
